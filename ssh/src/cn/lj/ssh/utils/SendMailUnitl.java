...
public class SendMailUnitl {
	...
	public static void senMail(String to,String code) {
		...
		try {
			...
			// 设置邮件的内容
			message.setContent("<h1>xx商城官方激活邮件!点下面链接完成激活操作!</h1><h3><a href='http://localhost:8080/ssh/user_active.action?code="+code+"'>http://localhost:8080/ssh/user_active.action?code="+code+"</a></h3>",
